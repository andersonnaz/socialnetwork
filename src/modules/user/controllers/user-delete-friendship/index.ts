...
const userDeleteFriendshipService = new UserDeleteFriendshipService(userInMemoryRepository);
const userDeleteFriendshipController = new UserDeleteFriendshipController(userDeleteFriendshipService);
