...
const userCreateFriendshipService = new UserCreateFriendshipService(userInMemoryRepository);
const userCreateFriendshipController = new UserCreateFriendshipController(userCreateFriendshipService);
