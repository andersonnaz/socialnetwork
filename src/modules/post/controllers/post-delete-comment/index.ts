...
const postDeleteCommentService = new PostDeleteCommentService(postInMemoryRepository);
const postDeleteCommentController = new PostDeleteCommentController(postDeleteCommentService);
