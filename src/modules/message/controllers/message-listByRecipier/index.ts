...
const messageListByRecipierService = new MessageListByRecipierService(messageInMemoryRepository);
const messageListByRecipierController = new MessageListByRecipierController(messageListByRecipierService);
